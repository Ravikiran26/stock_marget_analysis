  ...
  return (
    <div className="flex flex-col overflow-x-hidden bg-[#060c18]">
      ...
      {/* ══════════════════════════════════════════════════════════════════
          TESTIMONIALS
      ══════════════════════════════════════════════════════════════════ */}
      <section className="bg-[#060c18] py-20 px-6 border-t border-white/[0.04]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-3">What traders say</p>
            <h2 className="text-3xl font-black text-slate-100 tracking-tight">Real feedback from real traders</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              {
                quote: "Finally understood why I kept losing on expiry Thursdays. The pattern dashboard showed me I had a 28% win rate after 3pm. Never noticed it myself.",
                name: "Arjun S.",
                tag: "Options trader · Zerodha",
              },
              {
                quote: "Uploaded 6 months of Upstox trades in one go. The AI coaching on my biggest loss trade was more useful than anything I'd read online.",
                name: "Priya M.",
                tag: "Equity swing · Upstox",
              },
              {
                quote: "The revenge trading flag hit me hard. It correctly identified that I placed 4 trades after a ₹8,000 loss and all 4 were losers. Eye opening.",
                name: "Karthik R.",
                tag: "F&O trader · Dhan",
              },
            ].map(({ quote, name, tag }) => (
              <div key={name} className="rounded-2xl p-6 bg-[#0d1528] border border-[#1c2e4a] flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-xs mt-0.5">{tag}</p>
                </div>
              </div>
            ))}
          </div>
